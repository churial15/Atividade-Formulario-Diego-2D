...
if(isset($_GET['excluir'])) {
    ...
    $res = mysqli_query($conexao, "SELECT imagem_url FROM `formulario-diego-2d` WHERE id = $id");
    ...
    mysqli_query($conexao, "DELETE FROM `formulario-diego-2d` WHERE id = $id") or die("Erro ao excluir: " . mysqli_error($conexao));
...
if(isset($_POST['editar'])) {
    ...
    $update_sql = "UPDATE `formulario-diego-2d` SET nome='$nome', descricao='$descricao', preco=$preco WHERE id=$id";
...
$produtos = mysqli_query($conexao, "SELECT * FROM `formulario-diego-2d` ORDER BY id DESC");
